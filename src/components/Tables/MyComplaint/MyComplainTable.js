...
export default function MyComplaintTable({ data }) {
    Axios.defaults.withCredentials = true;
    const [confirmDialog, setConfirmDialog] = useState({ isOpen: !1, title: "", subtitle: "", yesButton: "", noButton: "" }), [successRegisterDialog, setSuccessRegisterDialog] = useState({ isOpen: !1, title: "", subtitle: "", yesButton: "", noButton: "" }), [notify, setNotify] = useState({ isOpen: !1, message: "", type: "" }), [viewEditDialog, setViewEditDialog] = useState({ isOpen: !1, title: "", subtitle: "", yesButton: "", noButton: "" }), [errorDialog, setErrorDialog] = useState({ isOpen: !1, title: "", subtitle: "", noButton: "" }), [successDialog, setSuccessDialog] = useState({ isOpen: !1, title: "", subtitle: "", yesButton: "", noButton: "" }), classes = useStyles(), [openPopup, setOpenPopup] = useState(!1), [full_name, setFullName] = useState(""), [complaint, setComplaint] = useState(""), [contact, setContact] = useState(""), [date_submitted, setDateSubmitted] = useState(""), [page, setPage] = useState(0), [rowsPerPage, setRowsPerPage] = useState(5), handleChangePage = (e, t) => { setPage(t) }, handleChangeRowsPerPage = e => { setRowsPerPage(+e.target.value); setPage(0) };
    function openInPopup(full_name, complaint, contact, date_submitted) { setOpenPopup(true); setFullName(full_name); setComplaint(complaint); setContact(contact); setDateSubmitted(date_submitted); }
    return (
        <div>
